...
def DecisionTree():
    ...
    print("DT without normalising: ", accuracy_score(y_test, y_pred,normalize=False))
...
def randomforest():
    ...
    model2= model2.fit(X,np.ravel(y))
...
def NaiveBayes():
    ...
    model3 = GaussianNB()
    model3 = model3.fit(X,np.ravel(y))
...
# Heading
w2 = Label(root, justify=LEFT, text="HealthPro: Your smart Health Assitant", fg="Red" ,bg="pink")
...
# labels
NameLb = Label(root, text="Name of the Patient", fg="Black", bg="pink")
NameLb.grid(row=6, column=0, pady=15, sticky=W)

#At least three symptoms required
